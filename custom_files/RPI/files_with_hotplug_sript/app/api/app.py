...
def cal_speed(str):
    proc = subprocess.Popen([str], stdout=subprocess.  PIPE, shell=True)
    (out, err) = proc.communicate()
    x = out.decode("utf-8").split()
    y = float(x[0])
    interface_speed = round((y/1000000)*8,2)
...
def device_con():
  try:
    resp = requests.get(
            "http://192.168.1.254:5000/devicecon"
       )
    return(resp.json())
  except:
...
def vpn1_connect():
    y = "uci show system.custom.internet"
    response=run_uci(y)
    data = response.split("=")
    data = data[1].split("'")
    data=int(data[1])
    # if data != 1:
    # 	result = {"id":1,"error":None,"result":"No Internet"
    #   }
    #   return(result)
...
def get_vpn1():
    ...
    #>>>>>>>>>>>>>>>>>
    try:
      with open ("/etc/openvpn/vpn1.auth", "r") as myfile:
    ...
    result = {
    "id":1,
    "result":{"vpn1_name":vpn1_name,"username":username, "password":password},
    "error":None
    }
    return(result)
...
def get_vpn2():
    ...
    result = {
    "id":1,
    "result":{"vpn2_name":vpn2_name,"username":username, "password":password},
    "error":None
    }
    return(result)
...
def set_loadbalance():
  ...
  if (total == 100):
     for i in range (len(wan_name)):
         if (wan_name[i]) == "WAN 1":
              uci1 = "uci set mwan3.wan_m1_w1.weight="+wan_weight[i]+";uci commit"
              y = run_uci(uci1)
              x = "Success"
         if(wan_name[i])=="WAN 2":
              uci2 = "uci set mwan3.wan2_m1_w1.weight="+wan_weight[i]+";uci commit"
              y = run_uci(uci2)
              x = "Success"
         if(wan_name[i])=="WAN 3":
              uci3 = "uci set mwan3.wan3_m1_w1.weight="+wan_weight[i]+";uci commit"
              y = run_uci(uci3)
              x = "Success"
         if(wan_name[i])=="WAN 4":
              uci4 = "uci set mwan3.wan4_m1_w1.weight="+wan_weight[i]+";uci commit"
              y = run_uci(uci4)
              x = "Success"
         if(wan_name[i])== "WAN 5":
              uci5 = "uci set mwan3.wan5_m1_w1.weight="+wan_weight[i]+";uci commit"
              y = run_uci(uci5)
              x = "Success"
         if(wan_name[i])== "WAN 6":
              uci6 = "uci set mwan3.wan6_m1_w1.weight="+wan_weight[i]+";uci commit"
              y = run_uci(uci6)
              x = "Success"
         if (wan_name[i])=="WWAN":
              uci7 = "uci set mwan3.wwan_m1_w1.weight="+wan_weight[i]+";uci commit"
              y = run_uci(uci7)
              x = "Success"
  else:
    x = "failed"
...
def set_lbinterface():
  ...
  for i in range (len(wan_name_enable)):
    if wan_name_enable[i] == "WAN 1":
      wan_name_enable[i] = "wan"
    if wan_name_enable[i] == "WAN 2":
      wan_name_enable[i]= "wan2"
    if wan_name_enable[i] == "WAN 3":
      wan_name_enable[i]= "wan3"
    if wan_name_enable[i] == "WAN 4":
      wan_name_enable[i] = "WAN 4"
    if wan_name_enable[i] == "WAN 5":
      wan_name_enable[i] = "wan5"
  ...
  for i in range (len(wan_name_disable)):
    if wan_name_disable[i] == "WAN 1":
      wan_name_disable[i] = "wan"
    if wan_name_disable[i] == "WAN 2":
      wan_name_disable[i]= "wan2"
    if wan_name_disable[i] == "WAN 3":
      wan_name_disable[i]= "wan3"
    if wan_name_disable[i] == "WAN 4":
      wan_name_disable[i] = "WAN 4"
    if wan_name_disable[i] == "WAN 5":
      wan_name_disable[i] = "wan5"
...
def disconnect_wan1():
    uci = "uci set network.wan.disabled='1';uci commit;/etc/init.d/network reload"
    response = run_uci(uci)
    data_dummy = {
    "id":"1",
    "result":"200 ok",
...
def connect_wan1():
    uci = "uci set network.wan.disabled='0';uci commit;/etc/init.d/network reload"
    response = run_uci(uci)
    data_dummy = {
    "id":"1",
    "result":"200 ok",
...
def edit_wan1():
  ...
  uci = "uci set network.wan.proto='pppoe';"+string1+username+";"+string2+password+";"+"uci commit"
  if contype == 'PPPoE':
    y = run_uci(uci)
    status = "connected"
  else:
...
def disconnect_wan2():
    uci = "uci set network.wan2.disabled='1';uci commit;/etc/init.d/network reload"
    y = run_uci(uci)
    data_dummy = {
    "id":"1",
    "result":"200 ok",
...
def connect_wan2():
    uci = "uci set network.wan2.disabled='0';uci commit;/etc/init.d/network reload"
    y = run_uci(uci)
    data_dummy = {
    "id":"1",
    "result":"200 ok",
...
def edit_wan2():
  ...
  uci1 = "uci set network.wan2.proto='pppoe';"+string1+username+";"+string2+password+";"+"uci commit"
  if contype == 'PPPoE':
    y = run_uci(uci1)
    status = "connected"
  else:
...
def disconnect_wan3():
    uci = "uci set network.wan3.disabled='1';uci commit;/etc/init.d/network reload"
    y = run_uci(uci)
    data_dummy = {
    "id":"1",
    "result":"200 ok",
...
def connect_wan3():
    uci = "uci set network.wan3.disabled='0';uci commit;/etc/init.d/network reload"
    response = run_uci(uci)
    data_dummy = {
    "id":"1",
    "result":"200 ok",
...
def edit_wan3():
  ...
  uci1 = "uci set network.wan3.proto='pppoe';"+string1+username+";"+string2+password+";"+"uci commit"
  if contype == 'PPPoE':
    y = run_uci(uci1)
    status = "connected"
  else:
...
def disconnect_wan4():
    uci = "uci set network.wan4.disabled='1';uci commit;/etc/init.d/network reload"
    response = run_uci(uci)
    data_dummy = {
    "id":"1",
    "result":"200 ok",
...
def connect_wan4():
    uci = "uci set network.wan4.disabled='0';uci commit;/etc/init.d/network reload"
    response = run_uci(uci)
    data_dummy = {
    "id":"1",
    "result":"200 ok",
...
def edit_wan4():
  ...
  uci1 = "uci set network.wan4.proto='pppoe';"+string1+username+";"+string2+password+";"+"uci commit"
  if contype == 'PPPoE':
    y = run_uci(uci1)
    status = "connected"
  else:
...
def disconnect_wan5():
    uci = "uci set network.wan5.disabled='1';uci commit;/etc/init.d/network reload"
    y = run_uci(uci)
    data_dummy = {
    "id":"1",
    "result":"200 ok",
...
def connect_wan5():
    uci = "uci set network.wan5.disabled='0';uci commit;/etc/init.d/network reload"
    y = run_uci(uci)
    data_dummy = {
    "id":"1",
    "result":"200 ok",
...
def edit_wan5():
  ...
  uci1 = "uci set network.wan5.proto='pppoe';"+string1+username+";"+string2+password+";"+"uci commit"
  if contype == 'PPPoE':
    response = run_uci(uci1)
    status = "connected"
  else:
...
def disconnect_wan6():
    uci = "uci set network.wan6.disabled='1';uci commit;/etc/init.d/network reload"
    response = run_uci(uci)
    data_dummy = {
    "id":"1",
    "result":"200 ok",
...
def connect_wan6():
    uci = "uci set network.wan6.disabled='0';uci commit;/etc/init.d/network reload"
    response = run_uci(uci)
    data_dummy = {
    "id":"1",
    "result":"200 ok",
...
def edit_wan6():
  ...
  uci1 = "uci set network.wan6.proto='pppoe';"+string1+username+";"+string2+password+";"+"uci commit"
  if contype == 'PPPoE':
    response = run_uci(uci1)
    status = "connected"
  else:
...
def wirelessnetwork_on():
  uci = "uci set wireless.radio0.disabled='0'; uci commit; wifi up radio0"
  response = run_uci(uci)
  data = "wifi on"
  result = {
        "id":1,
...
def wirelessnetwork_off():
  uci = "uci set wireless.radio0.disabled='1'; uci commit; wifi down radio0;/etc/init.d/network reload"
  response = run_uci(uci)
  data = "wifi off"
  result = {
        "id":1,
...
def ualevel_on():
    x="uci set system.pc.parental_ua='1';system.pc.parental_change='1';uci set system.pc.parental_a='0';uci set system.pc.parental_u='0';uci commit"
    y = "uci delete adblock.global.adb_sources;uci add_list adblock.global.adb_sources='UA';uci add_list adblock.global.adb_sources='Ads';uci add_list adblock.global.adb_sources='adaway';uci add_list adblock.global.adb_sources='adguard';uci add_list adblock.global.adb_sources='adguard_tracking';uci add_list adblock.global.adb_sources='android_tracking';uci add_list adblock.global.adb_sources='anti_ad';/etc/init.d/adblock reload"
    response = run_uci(x)
    res = run_uci(y)
    return("200 ok")
...
def ulevel_on():
    x="uci set system.pc.parental_u='1';system.pc.parental_change='1';uci set system.pc.parental_a='0';uci set system.pc.parental_ua='0';uci commit"
    y = "uci delete adblock.global.adb_sources;uci add_list adblock.global.adb_sources='U';uci add_list adblock.global.adb_sources='Ads';uci add_list adblock.global.adb_sources='adaway';uci add_list adblock.global.adb_sources='adguard';uci add_list adblock.global.adb_sources='adguard_tracking';uci add_list adblock.global.adb_sources='android_tracking';uci add_list adblock.global.adb_sources='anti_ad';/etc/init.d/adblock reload"
    response = run_uci(x)
    res = run_uci(y)
    return("200 ok")
...
def alevel_on():
    x="uci set system.pc.parental_a='1';system.pc.parental_change='1';uci set system.pc.parental_u='0';uci set system.pc.parental_ua='0';uci commit"
    y = "uci delete adblock.global.adb_sources;uci add_list adblock.global.adb_sources='A';uci add_list adblock.global.adb_sources='Ads';uci add_list adblock.global.adb_sources='adaway';uci add_list adblock.global.adb_sources='adguard';uci add_list adblock.global.adb_sources='adguard_tracking';uci add_list adblock.global.adb_sources='android_tracking';uci add_list adblock.global.adb_sources='anti_ad';/etc/init.d/adblock reload"
    response = run_uci(x)
    res = run_uci(y)
    return("200 ok")
...
def delete_whitelist():
  ...
  y = run_uci(uci1)
  a_file = open("/app/api/adw.txt", "r")
  lines = a_file.readlines()
  a_file.close()
  new_file = open("/app/api/adw.txt", "w")
  for line in lines:
    if line.strip("\n") != data_new:
        new_file.write(line)
  new_file.close()
...
def delete_blacklist():
  ...
  y = run_uci(uci1)
  a_file = open("/app/api/adb.txt", "r")
  lines = a_file.readlines()
  a_file.close()
  new_file = open("/app/api/adb.txt", "w")
  for line in lines:
    if line.strip("\n") != data_new:
        new_file.write(line)
  new_file.close()
...
def get_lan():
  try:
    resp = requests.get(
            "http://192.168.1.254:5000/getlan"
       )
    return(resp.json())
  except:
...
def addlan():
  ...
  dhcp =data['dhcp']
  data={"mac": mac,"ip": ip, "subnet": subnet, "gateway":gateway, "ippool1":ippool1, "ippool2":ippool2, "dhcp":dhcp}
  resp = requests.post("http://192.168.1.254:5000/addlan",data)
...
def wifi_net1():
    try:
      resp = requests.get(
            "http://192.168.1.254:5000/wifinet1"
       )
      return(resp.json())
    except:
...
def wifi_net2():
    try:
      resp = requests.get(
            "http://192.168.1.254:5000/wifinet2"
       )
      return(resp.json())
    except:
...
def wifi_net3():
    try:
      resp = requests.get(
            "http://192.168.1.254:5000/wifinet3"
       )
      return(resp.json())
    except:
...
def wifi_net4():
    try:
      resp = requests.get(
            "http://192.168.1.254:5000/wifinet4"
       )
      return(resp.json())
    except:
...
def wifinet1_status():
    try:
      resp = requests.get(
            "http://192.168.1.254:5000/wifinet1status"
       )
      return(resp.json())
    except:
...
def wifinet2_status():
    ...
    try:
      resp = requests.get(
            "http://192.168.1.254:5000/wifinet2status"
       )
      return(resp.json())
    except:
...
def wifinet3_status():
    try:
      resp = requests.get(
            "http://192.168.1.254:5000/wifinet3status"
       )
      return(resp.json())
    except:
...
def wifinet4_status():
    try:
      resp = requests.get(
            "http://192.168.1.254:5000/wifinet4status"
       )
      return(resp.json())
    except:
...
def wireless_status():
    # try:
    #   resp = requests.get(
    #         "http://192.168.1.254:5000/wirelessstatus"
    #    )
    #   return(resp.json())
    # except:
...
def disconnect_wifi1():
    try:
      resp = requests.get(
            "http://192.168.1.254:5000/wifinet1disconnect"
       )
      return(resp.json())
    except:
...
def disconnect_wifi2():
    try:
      resp = requests.get(
            "http://192.168.1.254:5000/wifinet2disconnect"
       )
      return(resp.json())
    except:
...
def disconnect_wifi3():
    try:
      resp = requests.get(
            "http://192.168.1.254:5000/wifinet3disconnect"
       )
      return(resp.json())
    except:
...
def disconnect_wifi4():
    try:
      resp = requests.get(
            "http://192.168.1.254:5000/wifinet4disconnect"
       )
      return(resp.json())
    except:
...
def connect_wifi1():
    try:
      resp = requests.get(
            "http://192.168.1.254:5000/wifinet1connect"
       )
      return(resp.json())
    except:
...
def connect_wifi2():
    try:
      resp = requests.get(
            "http://192.168.1.254:5000/wifinet2connect"
       )
      return(resp.json())
    except:
...
def connect_wifi3():
    try:
      resp = requests.get(
            "http://192.168.1.254:5000/wifinet3connect"
       )
      return(resp.json())
    except:
...
def connect_wifi4():
    try:
      resp = requests.get(
            "http://192.168.1.254:5000/wifinet4connect"
       )
      return(resp.json())
    except:
...
def add_network1():
  ...
  security=data['securityMode']
  password=data['password']
  data = {"name":name, "security":security,"password":password}
  try:
    resp = requests.post("http://192.168.1.254:5000/wifinet1addnetwork",data)
    result = {
      "result":"200 ok"
    }
    return(result)
...
def add_network2():
  ...
  data = {"name":name, "security":security,"password":password}
  try:
    resp = requests.post("http://192.168.1.254:5000/wifinet2addnetwork",data)
    result = {
      "result":"200 ok"
    }
    return(result)
...
def add_network3():
  ...
  data = {"name":name, "security":security,"password":password}
  try:
    resp = requests.post("http://192.168.1.254:5000/wifinet3addnetwork",data)
    result = {
      "result":"200 ok"
    }
    return(result)
...
def add_network4():
  ...
  data = {"name":name, "security":security,"password":password}
  try:
    resp = requests.post("http://192.168.1.254:5000/wifinet4addnetwork",data)
    result = {
      "result":"200 ok"
    }
    return(result)
...
def download_test():
  ...
  #aggregate speed calculation for speed boost
  ...
  #aggregate speed calculation for Load Balance
  uci = "uci show system.custom.loadbalancing"
  response = run_uci(uci)
  x=response.split(".")
  y = x[2]
  ...
  try:
    if speedbooststatus == "'1'\n" :
        agg_speed = (speed_eth1 + speed_eth2 + speed_eth3 + speed_eth4 + speed_eth5 + speed_eth6 + speed_wlan0)
    elif loadbalancingstatus == "'1'\n" :
            string1 = 'curl -w "%{speed_download} \n" http://speedtestserver.jaitra.com/1MB.zip -o /dev/null'
            string2 = 'curl -w "%{speed_download} \n" http://speedtestserver.jaitra.com/1MB.zip -o /dev/null'
            string3 = 'curl -w "%{speed_download} \n" http://speedtestserver.jaitra.com/1MB.zip -o /dev/null'
            string4 = 'curl -w "%{speed_download} \n" http://speedtestserver.jaitra.com/1MB.zip -o /dev/null'
            string5 = 'curl -w "%{speed_download} \n" http://speedtestserver.jaitra.com/1MB.zip -o /dev/null'
            string6 = 'curl -w "%{speed_download} \n" http://speedtestserver.jaitra.com/1MB.zip -o /dev/null'
            string7 = 'curl -w "%{speed_download} \n" http://speedtestserver.jaitra.com/1MB.zip -o /dev/null'
            ...
            def task(str):
                    ...
                    return x
            # creating threads
            t1 = threading.Thread(target=task(string1), name='t1')
            t2 = threading.Thread(target=task(string2), name='t2')
            t3 = threading.Thread(target=task(string3), name='t3')
            t4 = threading.Thread(target=task(string4), name='t4')
            t5 = threading.Thread(target=task(string5), name='t5')
            t6 = threading.Thread(target=task(string6), name='t6')
            t7 = threading.Thread(target=task(string7), name='t7')
            # starting threads
            t1.start()
            wlan0_speed = my_queue.get()
            speed_list.append(wlan0_speed)
            t2.start()
            eth1_speed = my_queue.get()
            speed_list.append(eth1_speed)
            t3.start()
            eth2_speed = my_queue.get()
            speed_list.append(eth2_speed)
            t4.start()
            eth3_speed = my_queue.get()
            speed_list.append(eth3_speed)
            t5.start()
            eth4_speed = my_queue.get()
            speed_list.append(eth4_speed)
            t6.start()
            eth5_speed = my_queue.get()
            speed_list.append(eth5_speed)
            t7.start()
            eth6_speed = my_queue.get()
            speed_list.append(eth6_speed)
            agg_speed = max(speed_list)
...
@app.route('/wan1user')
def display_wan1():
    uci_username = "uci show network.wan.username"
    uci_password = "uci show network.wan.password"
    uci_proto = "uci show network.wan.proto"
    x =run_uci(uci_username)
    try:
         y=x.split("=")
         username = y[1].strip().split("'")
         username = username[1]
    except:
         username = ""
    y=run_uci(uci_password)
    try:
         y=y.split("=")
         password=y[1].strip().split("'")
         password=password[1]
    except:
         password = ""
    y = run_uci(uci_proto)
    ...
    result = {"username":username,"password":password, "proto":proto}
    return(result)

@app.route('/wan2user')
def display_wan2():
    uci_username = "uci show network.wan2.username"
    uci_password = "uci show network.wan2.password"
    uci_proto = "uci show network.wan2.proto"
    x =run_uci(uci_username)
    try:
         y=x.split("=")
         username = y[1].strip().split("'")
...
@app.route('/wan3user')
def display_wan3():
    uci_username = "uci show network.wan3.username"
    uci_password = "uci show network.wan3.password"
    uci_proto = "uci show network.wan3.proto"
    x =run_uci(uci_username)
    try:
         y=x.split("=")
         username = y[1].strip().split("'")
...
@app.route('/wan4user')
def display_wan4():
    uci_username = "uci show network.wan4.username"
    uci_password = "uci show network.wan4.password"
    uci_proto = "uci show network.wan4.proto"
    x =run_uci(uci_username)
    try:
         y=x.split("=")
         username = y[1].strip().split("'")
...
@app.route('/wan5user')
def display_wan5():
    uci_username = "uci show network.wan5.username"
    uci_password = "uci show network.wan5.password"
    uci_proto = "uci show network.wan5.proto"
    x =run_uci(uci_username)
    try:
         y=x.split("=")
         username = y[1].strip().split("'")
...
@app.route('/wan6user')
def display_wan6():
    uci_username = "uci show network.wan6.username"
    uci_password = "uci show network.wan6.password"
    uci_proto = "uci show network.wan6.proto"
    x =run_uci(uci_username)
    try:
         y=x.split("=")
         username = y[1].strip().split("'")
...
#>>>>>>>>>>>>>>>>>>>>>>>Vpn Display username>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>

#>>>>>>>>>>>>>>>>>>>>>>>>>>Wireless username dispaly>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>

@app.route('/wifiuser1')
def wifiuser1():
    try:
      resp = requests.get(
            "http://192.168.1.254:5000/wifiuser1"
       )
      return(resp.json())
    except:
      result = {
...
def wifiuser2():
    try:
      resp = requests.get(
            "http://192.168.1.254:5000/wifiuser2"
       )
      return(resp.json())
    except:
      result = {
...
def wifiuser3():
    try:
      resp = requests.get(
            "http://192.168.1.254:5000/wifiuser3"
       )
      return(resp.json())
    except:
      result = {
...
def wifiuser4():
    try:
      resp = requests.get(
            "http://192.168.1.254:5000/wifiuser4"
       )
      return(resp.json())
    except:
      result = {
